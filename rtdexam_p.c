...
typedef struct _rtdexam_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } rtdexam_MIDL_TYPE_FORMAT_STRING;

typedef struct _rtdexam_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } rtdexam_MIDL_PROC_FORMAT_STRING;

typedef struct _rtdexam_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } rtdexam_MIDL_EXPR_FORMAT_STRING;
...
extern const rtdexam_MIDL_TYPE_FORMAT_STRING rtdexam__MIDL_TypeFormatString;
extern const rtdexam_MIDL_PROC_FORMAT_STRING rtdexam__MIDL_ProcFormatString;
extern const rtdexam_MIDL_EXPR_FORMAT_STRING rtdexam__MIDL_ExprFormatString;
...
static const rtdexam_MIDL_PROC_FORMAT_STRING rtdexam__MIDL_ProcFormatString =
    {
        0,
        {
...
static const rtdexam_MIDL_TYPE_FORMAT_STRING rtdexam__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IRTDUpdateEvent_ProxyInfo =
    {
    &Object_StubDesc,
    rtdexam__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    rtdexam__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _rtdexam_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _rtdexam_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IRtdServerStubVtbl,
    ( CInterfaceStubVtbl *) &_IRTDUpdateEventStubVtbl,
    0
...
PCInterfaceName const _rtdexam_InterfaceNamesList[] = 
{
    "IRtdServer",
    "IRTDUpdateEvent",
    0
...
const IID *  const _rtdexam_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _rtdexam_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _rtdexam, pIID, n)

int __stdcall _rtdexam_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _rtdexam, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _rtdexam, 2, *pIndex )
    
}

const ExtendedProxyFileInfo rtdexam_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _rtdexam_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _rtdexam_StubVtblList,
    (const PCInterfaceName * ) & _rtdexam_InterfaceNamesList,
    (const IID ** ) & _rtdexam_BaseIIDList,
    & _rtdexam_IID_Lookup, 
    2,
    2,
